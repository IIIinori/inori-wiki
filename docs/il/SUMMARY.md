...
* [主配置](config/main.md)
* [玩家资产](config/profile.md)

### 物品

* [物品配置](config/loot/items.md)
* [掉落池配置](config/loot/pools.md)
...
* [mobs.yml](config/maps/mobs.md)
* [objectives.yml](config/maps/objectives.md)
* [npc.yml](config/maps/npc.md)
* [preset 继承](config/maps/presets.md)
